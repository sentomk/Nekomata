// Cross-TU end-to-end runner: one managed group of two members. Versions
...
const bool k_section_initialized = [] {
  ...
  descriptor.group_id = "//cross:tu";
  descriptor.members = {"cross/a", "cross/b"};
  descriptor.publication_key = "cross-tu-e2e";
  descriptor.baseline_sequence = 0;
  descriptor.compatibility_id = "e2e-compatibility";
  descriptor.abi_id = "elf-e2e-patch";
  descriptor.generation_root_hint = "neko-cross-tu";
