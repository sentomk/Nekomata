...
| Cross-TU references | supported inside one published generation — fresh code can call functions and access mutable objects defined by sibling objects, including brand-new symbols |
